This personal project was bootstrapped with [Create React App](https://github.com/facebookincubator/create-react-app).
Then we add the [ignite](https://github.com/facebookincubator/create-react-app) architecture.
...
- react-router
- react-router-redux
- migration support for redux-persist

Needs to be added
- better bootstrap for scss
- assets management
- default components like material-ui
- i18n
